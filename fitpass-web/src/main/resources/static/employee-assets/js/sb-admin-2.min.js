...
document.addEventListener("DOMContentLoaded", function () {
    ...
    saveChangesButton.addEventListener("click", function () {
        ...
        tableRows.forEach(function (row, index) {
            ...
            var startTime = row.querySelector("td:nth-child(2) input").value;
            var endTime = row.querySelector("td:nth-child(3) input").value;
        ...
        var closeModalButton = document.querySelector("[data-dismiss='modal']");
...
$(document).ready(function() {
    ...
    // Lặp qua từng mục menu và kiểm tra đường dẫn của nó
    $(".nav-item").each(function() {
        var link = $(this).find("a").attr("th:href");

        // So sánh đường dẫn hiện tại với đường dẫn của mục menu
        if (currentPath === link) {
            // Nếu trùng khớp, thêm lớp 'active' vào mục menu
            $(this).addClass("active");
        } else {
            // Nếu không trùng khớp, loại bỏ lớp 'active' khỏi mục menu
