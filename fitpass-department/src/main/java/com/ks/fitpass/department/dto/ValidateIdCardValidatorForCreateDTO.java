...
public class ValidateIdCardValidatorForCreateDTO implements ConstraintValidator<EmployeeCreateDTO.ValidateIdCard, String>{

    @Override
    public void initialize(EmployeeCreateDTO.ValidateIdCard constraintAnnotation) {
