...
public class ValidateIdCardValidator implements ConstraintValidator<EmployeUpdateDTO.ValidateIdCard, String>{

    @Override
    public void initialize(EmployeUpdateDTO.ValidateIdCard constraintAnnotation) {
